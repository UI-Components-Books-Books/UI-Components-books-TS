...
export const AudioSize: Story = {
    parameters: {
        docs: {
            description: {
                story: 'La propiedad `size` nos permite cambiar el tamaño de nuestro reproductor a uno más pequeño. Por el momento, solo está disponible el tamaño `small`.'
            }
        }
    },
    ...Default.argTypes,
