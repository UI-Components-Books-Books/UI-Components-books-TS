...
export const Default: Story = {
    parameters: {
        docs: {
            description: {
                story: "El componente `Radio` es un elemento personalizado que permite manejar diferentes estados en su interior. Es especialmente útil en formularios cuando el usuario necesita seleccionar un valor de distintas opciones disponibles. Haz clic en `Show code` en la parte inferior para ver y utilizar este ejemplo."
            }
        }
    },
    argTypes: {
...
export const States: Story = {
    parameters: {
        docs: {
            description: {
                story: "Utilizando la propiedad `state`, se pueden manejar los múltiples estados del componente, tales como: `right`, y `wrong`. Estos dos muestran un ícono SVG dentro del componente."
            }
        }
    },
    argTypes: {
