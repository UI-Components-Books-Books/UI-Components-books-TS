...
export const WithoutCaption: Story = {
    parameters: {
        docs: {
            description: {
                story: "Utilizando la propiedad `noCaption`, podemos ocultar la descripción de la imagen. Además, esta propiedad no genera conflictos si necesitas colocarle una propiedad `alt` a tu imagen."
            }
        }
    },
    args: {
...
export const ImageSize: Story = {
    parameters: {
        docs: {
            description: {
                story: "Con la propiedad `size` puedes cambiar el tamaño de tu imagen. Puedes utilizar cualquiera de las más de 60 unidades de medida que existen en CSS."
            }
        }
    },
    args: {
