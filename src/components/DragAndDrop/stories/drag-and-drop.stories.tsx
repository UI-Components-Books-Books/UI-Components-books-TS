...
function ButtonWithCustomHook() {
    ...
    return (
        <Button label="Try again" onClick={handleResetDnd} addClass='button-story' />
    )
}
...
export const Default: Story = {
    parameters: {
        docs: {
            description: {
                story: "El componente `DragAndDrop` nos permite usar la HTML Drag and Drop API de una forma más sencilla e intuitiva. Construido a partir del paquete `@dnd-kit`, este componente provee diferentes funcionalidades, tales como la validación de los elementos arrastrables y todos los mecanismos necesarios para que sea accesible para personas con discapacidades. Para su implementación, solo necesitamos importar el componente `<DragAndDrop/>`. Este incluye los componentes `<DragAndDrop.Container/>`, `<DragAndDrop.Drag/>` y `<DragAndDrop.Drop/>`, necesarios para su uso. Haz clic en `Show code` en la parte inferior para ver y utilizar este ejemplo."
            }
        }
    },
    args: {
        ...
        children: (
            <Row justify-content="center" align-items="center">
                ...
                <Col md="12">
                    <Row justify-content="center" align-items="center">
                        <Col xs='11' mm='10' md='9' lg='5' hd='4'>
                            <DragAndDrop.Drop id='droppable' validate={['B']} label='droppable' addClass="drop-story">
                                <p>Droppable B</p>
                            </DragAndDrop.Drop>
                        </Col>
                        <Col xs='11' mm='10' md='9' lg='5' hd='4'>
    ...
    render: function Render(args) {
        ...
        return (
            <>
                ...
                <Button onClick={handleValidation} addClass='button-story'>Check</Button>
            </>
        )
    }
}
...
export const ResetDrag: Story = {
    parameters: {
        docs: {
            description: {
                story: "Continuando con el tema de validación, para reiniciar tu `<DragAndDrop/>`necesitas usar la función `handleResetDnd` proveniente del custom hook `useDragAndDropContext`."
            }
        }
    },
    args: {
