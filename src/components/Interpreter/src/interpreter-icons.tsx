...
export const AudioTextIcon = ({ ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 19.61 13.13"
    aria-hidden="true"
    focusable="false"
    fill="currentColor"
    {...props}
  >
    <g>
      <path
        d="M5.12,3.96C5.12,3.96,5.13,3.96,5.12,3.96c0-1.11,0-2.23,0-3.34c0-0.1,0-0.21-0.03-0.31
					c-0.04-0.17-0.16-0.27-0.32-0.3C4.62-0.02,4.48,0.03,4.39,0.16c-0.04,0.05-0.07,0.1-0.1,0.15C3.74,1.12,3.07,1.81,2.25,2.36
					C1.68,2.75,1.11,2.84,0.47,2.58c-0.25-0.1-0.31-0.07-0.36,0.19C-0.04,3.52-0.03,4.28,0.1,5.04c0.06,0.32,0.11,0.34,0.4,0.2
					C1.04,5,1.54,5.05,2.03,5.38c0.48,0.32,0.93,0.68,1.33,1.1c0.36,0.37,0.66,0.78,0.97,1.18C4.46,7.82,4.6,7.92,4.82,7.85
					c0.22-0.07,0.29-0.23,0.3-0.44c0-0.07,0-0.15,0-0.22C5.12,6.11,5.12,5.04,5.12,3.96z"
      />
      <path
        d="M6.33,4.41c0.15,0,0.3,0,0.44,0c0.44,0,0.43,0,0.42-0.43c0-0.16-0.07-0.2-0.21-0.2
					c-0.37,0.01-0.74,0-1.11,0c-0.43,0-0.42,0-0.4,0.44c0.01,0.14,0.05,0.2,0.19,0.19C5.88,4.41,6.1,4.41,6.33,4.41z"
      />
      <path
        d="M5.49,3.31c0.11-0.02,0.17-0.1,0.25-0.16C6.05,2.9,6.36,2.64,6.67,2.37c0.31-0.26,0.3-0.26-0.01-0.54
					c-0.1-0.1-0.17-0.1-0.28-0.01c-0.26,0.22-0.54,0.42-0.8,0.63C5.53,2.5,5.46,2.54,5.47,2.63C5.47,2.85,5.45,3.08,5.49,3.31z"
      />
      <path
        d="M5.47,5.3c0,0.36,0,0.36,0.27,0.57C5.9,6,6.06,6.13,6.23,6.26C6.56,6.51,6.55,6.5,6.84,6.21
					C6.95,6.1,6.92,6.05,6.82,5.97C6.49,5.7,6.16,5.42,5.83,5.15C5.74,5.07,5.65,4.93,5.54,4.98C5.41,5.03,5.48,5.2,5.47,5.3z"
      />
    </g>
...
export const HandsIcon = ({ ...props }) => (
  <svg
    ...
    {...props}
  >
    <style>{"enableBackground: new 0 0 157.39 157.39;"}</style>
