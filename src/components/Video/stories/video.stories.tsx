...
export const Default: Story = {
    parameters: {
        docs: {
            description: {
                story: "El componente `Video` es una personalización del video nativo de HTML. Además, cuenta con diversas funcionalidades como la integración de audio descriptivo. Para su implementación, solo necesitas importar el componente `<Video />`. Haz clic en `Show code` en la parte inferior para ver y utilizar este ejemplo."
            }
        }
    },
    args: {
...
export const AudioDescription: Story = {
    parameters: {
        docs: {
            description: {
                story: "Utilizando la propiedad `audio` puedes colocar un audio descriptivo al video."
            }
        }
    },
    args: {
...
export const Poster: Story = {
    parameters: {
        docs: {
            description: {
                story: "Para agregar un póster al video, puedes usar la propiedad `poster`."
            }
        }
    },
    args: {
