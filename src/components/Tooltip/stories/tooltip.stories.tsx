...
export const Distance: Story = {
    parameters: {
        docs: {
            description: {
                story: "Utilizando la propiedad `distance`, podemos modificar la distancia entre nuestro `Button` y el `<Tooltip/>`."
            }
        }
    },
    args: {
