...
export const MultipleAccordionsOpen: Story = {
    parameters: {
        docs: {
            description: {
                story: "Utilizando la propiedad `allowMultiple`, puedes cambiar el comportamiento por defecto del acordeón y permitir que se mantengan dos o más acordeones abiertos al mismo tiempo."
            }
        }
    },
    args: {
...
export const WithADefaultIndex: Story = {
    parameters: {
        docs: {
            description: {
                story: "Con la propiedad `defaultIndex`, podemos decidir qué acordeón debe aparecer abierto al momento de mostrarse en un grupo de acordeones. Ten en cuenta que esta propiedad se maneja igual que las posiciones de un `Array`, por lo que el número `0` corresponderá al primer acordeón del grupo, y así sucesivamente."
            }
        }
    },
    args: {
